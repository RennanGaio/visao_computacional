...
if __name__ == '__main__':
    ...
    imagem_linha_infinito = np.zeros((1500, 1500, 3), dtype=np.uint8)

    #cv2.imshow("original", imagem)
    rows, cols, channels = imagem.shape
    imagem_linha_infinito[1500-rows:1500, 1500-cols:1500] = imagem


    #cria imagem com linhas marcando retas paralelas no mundo real
    imagem=traca_linhas(imagem)
    ...
    cv2.imshow("remocao de perspectiva", imagem_auxiliar)
